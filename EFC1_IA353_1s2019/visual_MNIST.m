...
% Para visualizar os dados de teste, � necess�rio trocar os trechos comentados.
clear all;
load('data.mat');
% load('test.mat');
[nl,nc] = size(X);
...
%             v(i,j) = Xt(ind,k);
    ...
    disp(S(ind,:));
%     disp(St(ind,:));
    disp('Digite ENTER para visualizar o proximo digito ou CTRL-C para interromper a execucao')
    pause;
end
